...
router.route("/update-cover-image").put(varifyJWT, upload.single("coverImage"), updateUserCoverImage);
router.route("/c/:username").get(varifyJWT, getUserChannelsDetails);
